package app.padel.android.widget
...
import app.padel.android.padel
import app.padel.android.ui.components.formatScore
import app.padel.android.ui.components.team
import app.padel.android.ui.theme.DarkPalette
import app.padel.android.ui.theme.LightPalette
...
private fun Content(context: Context, g: LocalGame?) {
    val open = Intent(Intent.ACTION_VIEW, Uri.parse(g?.let { "padel://g/${it.code}" } ?: "padel://home"), context, MainActivity::class.java)
    Column(
