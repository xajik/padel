/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8a357af30097984384ecca790ee788b0)
...
interface __BaseEnv_Env {
	...
	SITE_URL: "https://padel-americanoo.com";
	ALLOWED_HOSTS: "padel-americanoo.com,www.padel-americanoo.com,padel-web.xajik0.workers.dev,padel-mcp.xajik0.workers.dev,localhost,127.0.0.1";
	GAMES: DurableObjectNamespace<import("./src/index").GameRoom>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_URL" | "ALLOWED_HOSTS">> {}
}
