...
import app.americanoo.engine.nextRound
import app.americanoo.engine.setScore
...
class GameRepositoryTest {
    ...
    fun organizerLinkGrantsEditingAndCodeFollows() = runTest {
        ...
        assertFailsWith<app.americanoo.engine.EngineError> { spectator.score(code, 0, 1, 10, null) }
        ...
        assertNull(repo().join("americanoo://g/$code?key=nope").organizerKey)
