...
export function llmsTxt(): string {
  ...
  return [
    ...
    `- [MCP server](${absoluteUrl("/docs/mcp")}): connect an AI assistant to create anonymous games, join them by code, enter scores and read standings. Endpoint: ${absoluteUrl("/mcp")}`,
    "",
    "## Optional",
    "",
